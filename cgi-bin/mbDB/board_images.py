...
for s in subtypes:
    ...
    for sn in barcodes[s]:
        ...
        try:
            ...
            print('<td colspan=2>')
            print('<a href="get_image.py?board_id=%(id)s&view=Top" target="_blank"><img src="get_image.py?board_id=%(id)s&view=Top" width=400 height=auto></a>' % {'id':board_id})
            print('</td>')
            print('<td colspan=2>')
            print('<a href="get_image.py?board_id=%(id)s&view=Bottom" target="_blank"><img src="get_image.py?board_id=%(id)s&view=Bottom" width=400 height=auto></a>' % {'id':board_id})
            print('</td>')
            print('</tr>')
        except:
            print('<tr>')
